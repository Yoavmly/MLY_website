...
class why_mly_main_block extends Block
{
    ...
    {
        return [
            'paragraph_1' => get_field('paragraph_1'), // Split into array of words
    ...
    public function fields(): array
    {
        ...
        $fields
            ->addText('paragraph_1',[
                'label' => 'Paragraph 1',
                'instructions' => 'Enter Paragraph here (this would appear on 4th click on the heading!)',
                'required' => true,
            ])
            ->addText('paragraph_2',[
                'label' => 'Paragraph 2',
                'instructions' => 'Enter paragraph here (this would appear on scroll after the horizontal line)',
                'required' => true,
            ])
            ;
